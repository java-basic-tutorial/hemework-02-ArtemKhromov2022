...
public class Task01 {
    public static void main(String[] args) {
        ...
        System.out.println("Month with the lowest temperature in a year: " + months[coldMonth]);
        System.out.println("The month with the highest temperatures in a year: " + months[hotMonth]);
